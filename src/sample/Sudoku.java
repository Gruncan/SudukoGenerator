...
public class Sudoku {
    ...
    private class SudokuGenerator {
        ...
        private void createSolveableBoard(){
            ...
            System.out.println("Pair at " + randomRow + " "+ randomColumn);

            if(board[randomRow][randomColumn] != NO_VALUE){
                int index1 = (10 - (randomRow +1)-1);
                int index2 = (10 - (randomColumn +1)-1);
                System.out.println("Symmetric at " + index1 + " "+ index2 + " value: "+ board[index1][index2]);
